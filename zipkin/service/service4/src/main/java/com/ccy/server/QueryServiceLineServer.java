...
public class QueryServiceLineServer {
    ...
    @RequestMapping("querySeriviceName4")
    public String querySeriviceName4() throws IOException {
        log.info("---"+ymlConfig.getPort());
        //String result=ccyHttpClient.httpGet("http://localhost:9084/queryServiceLineServer/querySeriviceName");
